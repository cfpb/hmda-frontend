...
jest.unmock('../../../src/filing/actions/fetchNewFiling.js')
import * as types from '../../../src/filing/constants'
import fetchNewFiling from '../../../src/filing/actions/fetchNewFiling.js'

import configureMockStore from 'redux-mock-store'
import thunk from 'redux-thunk'
import { createFiling } from '../../../src/filing/api/api.js'
...
createFiling.mockImplementation((id) => Promise.resolve(filingData))
    ...
    store
      ...
      .then(() => {
        expect(store.getActions()).toEqual([
          { type: types.REQUEST_FILING, id: 'a' },
          {
