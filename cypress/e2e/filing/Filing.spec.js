...
import { getFilingPeriods, sortFilingYears } from "../../../src/common/constants/configHelpers"
...
describe("Complete Profile Page", () => {
  ...
  it("Navigate to the profile page and ensures the correct information is visible", () => {
    ...
    cy.get('[style="color: black; text-decoration: none; cursor: pointer;"]').click()
    cy.get(".profile_form_container > :nth-child(1) > input").should("have.value","Frontend")
  ...
  it("Removes associated institution, banner should popup saying that one associated institution is required to use the filing platform", () => {
    ...
    cy.get(".alert-heading").contains("An institution must be associated with your account.")
  })
