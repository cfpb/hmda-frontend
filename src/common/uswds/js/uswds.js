...
*/
    ...
    5: [
      ...
      { '../delegate': 7, '../delegateAll': 8, 'object-assign': 4 },
    ],
    6: [
      function (require, module, exports) {
        'use strict'
    ...
    20: [
      function (require, module, exports) {
        ...
        const dateRangePicker = behavior(
          ...
          {
            init(root) {
              selectOrMatches(DATE_RANGE_PICKER, root).forEach(
                (dateRangePickerEl) => {
          ...
          {},
          {
            ...
            teardown(root) {
              selectOrMatches(INPUT, root).forEach((fileInputEl) => {
                const fileInputTopElement =
                  fileInputEl.parentElement.parentElement
    ...
    23: [
      function (require, module, exports) {
        ...
        navigation = behavior(
          ...
          {
            init(root) {
              const trapContainer = root.matches(NAV)
                ? root
      ...
      function (require, module, exports) {
        ...
        const createInPageNav = (inPageNavEl) => {
          ...
          const inPageNavTitleHeadingLevel = Sanitizer.escapeHTML`${
            inPageNavEl.dataset.titleHeadingLevel ||
            IN_PAGE_NAV_TITLE_HEADING_LEVEL
          }`
          ...
          const inPageNavTitle = document.createElement(
            inPageNavTitleHeadingLevel,
          )
        ...
        const inPageNavigation = behavior(
          ...
          {
            init(root) {
              selectOrMatches(`.${IN_PAGE_NAV_CLASS}`, root).forEach(
                (inPageNavEl) => {
    ...
    25: [
      function (require, module, exports) {
        ...
        const setValueOfMask = (el) => {
          const { value } = el
          const placeholderVal = `${el.dataset.placeholder.substr(
            value.length,
          )}`
        ...
        const cleanUpModal = (baseComponent) => {
          ...
          if (originalLocationPlaceHolder) {
            for (
              ...
              const attribute =
                originalLocationPlaceHolder.attributes[attributeIndex]
              if (attribute.name.startsWith('data-original-')) {
                // data-original- is 14 long
                modalContent.setAttribute(
                  attribute.name.substr(14),
                  attribute.value,
                )
              }
            }
          ...
          teardown(root) {
            selectOrMatches(MODAL, root).forEach((modalWindow) => {
              ...
              document
                .querySelectorAll(`[aria-controls="${modalId}"]`)
                .forEach((item) =>
                  item.removeEventListener('click', toggleModal),
                )
            })
          },
          focusTrap: null,
  ...
  `
      ...
      function (require, module, exports) {
        ...
        const createInitialStatus = (input) => {
          ...
          const checklistItems =
            validationContainer.querySelectorAll(CHECKLIST_ITEM)
          const validationElement = input.getAttribute(
    ...
    37: [
      ...
      },
      {
        ...
        '../../../usa-input-prefix-suffix/src/index': 26,
    ...
    45: [
      ...
      { 'object-assign': 4, 'receptor/behavior': 5 },
    ],
    46: [
      function (require, module, exports) {
        'use strict'
    ...
    55: [
      ...
      { './toggle-field-mask': 54, 'resolve-id-refs': 13 },
    ],
    56: [
      function (require, module, exports) {
        'use strict'
          ...
          Object.entries(el.dataset).forEach((_ref) => {
            ...
            if (key.startsWith('validate')) {
              ...
              const statusComplete =
                el.dataset.validationComplete || 'status complete'
