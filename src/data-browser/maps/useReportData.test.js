import { gatherReportData } from './useReportData'
...
const FILTER1_STATE_BY_V2 = {[FEATURE_S_NORM]: {loanType: { 1: 233237, 2: 34218, 3: 34640, 4: 775 }}}
const FILTER1_STATE_AT = {"1": 302870, "2": 12745, "3": 61845, "4": 75460, "5": 18484, "6": 72672, "7": 164, "8": 339}

const FILTER2_STATE_BY_V1 = {[FEATURE_S_NORM]: {actionTaken: { 1: 34640, 2: 1444, 3: 5105, 4: 9721, 5: 2898, 6: 12585, 7: 13, 8: 39 }}}
const FILTER2_STATE_LT = {"1":406855,"2":69739,"3":66445,"4":1540}

const FILTER1_COUNTY_BY_V2 = {[FEATURE_C]: {loanType: {1: 1480, 2: 64, 3: 43, 4: 5}}}
const FILTER1_COUNTY_AT = {1: 1592, 2: 68, 3: 251, 4: 381, 5: 81, 6: 333, 8: 3}

const FILTER2_COUNTY_BY_V1 = {[FEATURE_C]: {actionTaken: {1: 43, 2: 2, 3: 13, 4: 13, 5: 3, 6: 10, 8: 1}}}
...
describe('State Report', () => {
  ...
  it('with two filters', () => {
    const data = gatherReportData(stateOpt, FEATURE_S, BASE_STATE_2019, combinedFilter1, FILTER1_STATE_BY_V2, combinedFilter2, FILTER2_STATE_BY_V1)
...
describe('County Report', () => {
  ...
  it('with two filters', () => {
    const data = gatherReportData(countyOpt, FEATURE_C, BASE_COUNTY_2019, combinedFilter1, FILTER1_COUNTY_BY_V2, combinedFilter2, FILTER2_COUNTY_BY_V1)
