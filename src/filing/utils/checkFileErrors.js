...
function missingTransmittalSheet(file, sample) {
 if (!extensionIsNotTxt(file) && sample !== '1|')
   return 'Your file appears to be a text file (.txt) but has invalid content. Please ensure you are uploading a pipe-delimited, UTF-8 encoded text file and that your transmittal sheet begins with 1.'
}
