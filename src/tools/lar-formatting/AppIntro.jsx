  ...
  return [
    ...
    >
      <React.Fragment>
        ...
        <p>
          Follow the <Link to={`/documentation/${defaultDocsPeriod}/tools/lar-formatting/`}>Excel LAR Formatting Tool instructions</Link> to format your data into a pipe delimited text file.
        </p>
      </React.Fragment>
    </Heading>,
