  ...
  return (
    <div className="grid" id="main-content">
      ...
      <div className="alert" style={{ marginTop: '3em' }}>
        <p><b>1/07/2022:</b> We are experiencing a delay in processing the latest Fixed and Adjustable Rate Tables. We are working to resolve the issue and will update the 01/10/2022 APOR tables as soon as possible.</p>
        <p><b>11/15/2021:</b> The publication of Average Prime Offer Rates (APOR) for the week of November 15, 2021 was delayed. These data are now available on the Bureau’s Rate Spread Calculator above.</p>
