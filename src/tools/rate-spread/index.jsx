  ...
  return (
    <div className="grid" id="main-content">
      ...
      <div className="alert" style={{ marginTop: '3em' }}>
        <p><b>11/12/2021:</b> We are experiencing a delay in processing the latest Fixed and Adjustable Rate Tables. We are working to resolve the issue and will update the 11/15 APOR tables as soon as possible.</p>
